...
// MainnetGenesisHash to enforce below configs on.
var (
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		TerminalTotalDifficulty:       MainnetTerminalTotalDifficulty, // 58_750_000_000_000_000_000_000, difficulty bomber
		TerminalTotalDifficultyPassed: true,
		Ethash:                        new(EthashConfig),
		Harmony:                       new(HarmonyConfig),
	}
	...
	TestChainConfigClique = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, false, nil, &CliqueConfig{Period: 1, Epoch: 30000}, nil}
...
type HarmonyConfig struct {
	Period uint64 `json:"period"` // Number of seconds between blocks to enforce
	Epoch  uint64 `json:"epoch"`  // Epoch length to reset votes and checkpoint
	//Validators []common.Address `json:"validators"` // Genesis validator list, //@keep，看能否从POA的创世块中获取validators
}
